...
const schemaFlux = require('../schema/flux.json')
const schemaFavFlux = require('../schema/favFlux.json')
...
exports.validateFlux = payload => validate(schemaFlux, payload)
exports.validateFavFlux = payload => validate(schemaFavFlux, payload)
